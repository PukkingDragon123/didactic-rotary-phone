...
(function (CH) {
  ...
  CH.TOWER = [
    ...
    { floor: 5, name: 'Shift Leadership', color: '#7b4fb0', rooms: [U('crew2', 'Hire New Kevin', 400, 'An extra crew member to assign on the floor.'), U('grill3', 'Legendary Grill', 350, 'Patties cook very fast.'), U('wringer', 'Mop Wringer', 300, 'Mop dirt builds half as fast; water never becomes soup.'), U('patience2', 'Free Coffee Station', 320, 'Customers wait much longer.'), U('morale', 'Break Room Couch', 280, 'Coworkers chat less, work more.'), U('incidents', 'Fire Blanket', 300, 'Incidents resolve with one click.'), U('coffee', 'Espresso Machine', 250, 'Chubby loses less energy per shift.')] },
    { floor: 6, name: 'Management', color: '#2f7a4a', rooms: [U('chair', 'Ergonomic Chair', 600, 'Manager tasks get more time.'), U('spreadsheet', 'Spreadsheet Wizardry', 550, 'Inventory targets shown with +/-5% hints.'), U('hr', 'HR Department', 650, 'Schedule constraints are highlighted.'), U('inventoryai', 'Inventory AI', 700, 'Inventory auto-fills to projected demand.'), U('franchise', 'Franchise Handbook', 800, 'Promotions need one fewer shift.'), U('parking', 'Reserved Parking', 500, 'Commute is instant (no walk to work).'), U('tips3', 'Legendary Service', 600, '+30% tips.')] },
    { floor: 7, name: 'Regional', color: '#c8a030', rooms: [U('car', 'Company Car', 1500, 'Travel anywhere instantly. Heated seats.'), U('tastebuds', 'Trained Palate', 1200, 'Sauce notes are exact, never fuzzy.'), U('saucelab', 'Sauce Lab', 1400, 'Two extra taste tests.'), U('regionalbonus', 'Regional Bonus', 1300, 'Every shift pays an extra $200.'), U('map', 'Provincial Map', 1000, 'Hospital visits take no time.'), U('airmiles', 'Air Miles', 1100, 'Mom gets a nicer room (+mood).'), U('pension', 'Pension Plan', 1600, 'Interest: +1% of savings each day.')] },
    { floor: 8, name: 'Vice Presidency', color: '#1b3a6a', rooms: [U('thesaurus', 'Buzzword Thesaurus', 3000, 'Extra buzzword tiles in every meeting.'), U('standing', 'Standing Desk', 2500, 'Synergy decays slower.'), U('golf', 'Golf Membership', 2800, 'The board starts every meeting nodding.'), U('synergy', 'Synergy Itself', 3200, 'Pancakes no longer crash the meter.'), U('options', 'Stock Options', 4000, 'Every shift pays +$600.'), U('assistant', 'Executive Assistant', 3500, 'Emails and phone are handled; +energy.'), U('jet', 'Corporate Jet', 4500, 'Purely decorative. Brenda is furious.')] },
    { floor: 9, name: 'C-Suite', color: '#1a1a24', rooms: [U('authority', 'Taste Authority', 8000, 'Burger flaws are underlined for you.'), U('patent', 'Burger Patent', 9000, 'Every shift pays +$1500.'), U('museum', 'Burger Museum', 7500, 'A moose statue of you. +reputation.'), U('veto', 'Executive Veto', 8500, 'Reject a burger for any reason with no penalty.'), U('spatula', 'Golden Spatula', 10000, 'All kitchen games: extra combo bonus.'), U('pickles', 'Pickle Empire', 9500, 'Every shift pays +$1000.'), U('statue', 'Moose Statue Fund', 7000, 'Mom gets flowers every day (+mood).')] },
    { floor: 10, name: 'Penthouse', color: '#f5c33b', rooms: [U('healthplan', 'Health Plan For All', 25000, "Pays $20,000 toward Mom's bill immediately."), U('buym', 'Buy Back The M', 30000, 'The M restaurant is now also a D. Every shift pays +$3000.'), U('brenda', 'Retire Brenda With Honours', 15000, 'Brenda gets Fridays off. She cries. Once.'), U('chubbyday', 'Chubby Day', 12000, 'A provincial holiday. +reputation forever.'), U('rename', "Rename to Chubby's", 40000, 'The big D becomes a big C. Every shift pays +$5000.'), U('hedgehog', 'Blue Hedgehog Sponsorship', 20000, 'Man Egg appears on all cups. +tips.'), U('pancakes', 'Pancake Fridays', 10000, 'Every Friday, pancakes for the crew. +energy.')] },
  ];
